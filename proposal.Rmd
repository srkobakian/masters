...
The types of cartograms and the algorithms used are contrasted using time, error, and subject preferences. 




<!-- Introduce cartogram alternatives, mosiac tile and hexagon maps, sevral papers regarding creation
-->
...
The authors follow with the paper describing the applications of cartograms [-@TSOTAIC] and discuss social, political and epidemiological applications. They cite the 'cartogram can better show the distribution' [@CBACCC] when considering the spread of a diesease. 
...
Australia has a unique population distribution, spatial relationships which are population based are also unique. (Attempt to apply mosiac algorithms to SA areas) 
-->
however their use for Australia has been limited, namely due to the way Australian area boundaries have been influenced by the population.
