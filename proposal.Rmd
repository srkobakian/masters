...
Journalist Nick Evershed uses the headline "Australian electorates vary greatly in size, which makes it extremely difficult to present election results geographically. We've come up with a solution" [-@BBBEM]. This prefaces a uniquely Australian issue. The strong disparity in the sizes of the electorates, ranging between 30 and 1,587,758 sq km, immediately led to the consideration of a cartogram display. Citing the prevalence of cartograms in the US media, however in the context of Australia they are quickly are discounted. Evershed points to 150hexagons.com as a step toward a display that is more representative and emphasises each electorate equally, however Australia become unrecognisable. This inspired Evershed and Dance's interactive map [@AERIP] where each electorate is represented by a displaced circle, that are sized according the population. 
...
This study also endorses Amazon Mechanical Turk [-@AMT] as a source of capable workers to view the line-ups as an "univolved observer" is necessary to validate the design.
...
This algorithm takes a set of polygons and creates a map of tesselatted hexagons, representing a single geographical area with a single hexagon.
...
1. Began SugaRbag package; to organise and document functions that implement the hexmap algorithm
    ...
    - allowed data to be provided in different formats eg. Rda or ESRI
    ...
    - allow users to provide their own focal points eg. centre of Australia, regional cities
...
To extend Chapter 1, we plan to incorporate repelling and attraction [link Xiaoyue Cheng] mechanisms inspired by Xiaoyue Cheng.
