...
Geographical areas maintain their geographic shape, size and location.
This preserves spatial relationships, and data for the surrounding neighbours can be reasonably considered related.
Alternatively, cartograms are used to focus on the spatial distribution within the geographically related data. Geographical features are foregone in order to prioritse spatial distributions of the data.
